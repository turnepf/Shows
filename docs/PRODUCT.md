...
3. **Members** — the five members with the most recent non-seed activity (a show they added, were suggested, or had shared in — edits or archives of seeded rows don't count) are featured up top. A "Browse all members ▾" disclosure underneath reveals the rest of the roster, alphabetized. This keeps the home page leading with active profiles while still letting visitors reach anyone they're looking for. If no member has any non-seed activity yet, the disclosure stays collapsed and the featured row falls back to the first five members.
