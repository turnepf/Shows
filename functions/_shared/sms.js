...
// alerts. Reads TWILIO_ACCOUNT_SID, TWILIO_AUTH_TOKEN, TWILIO_PHONE_NUMBER from
// Cloudflare Pages secrets; if any are missing the helper short-circuits with a
// useful error instead of throwing, so callers can degrade gracefully (e.g.
// recommendation alerts shouldn't block a share if SMS is misconfigured).
